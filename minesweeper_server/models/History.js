...
var History = {
  ...
  getLeaderBoard: function(callback) {
    return db.query(
      "select Users.FirstName, Users.LastName, History.Score, History.Difficulty, History.Date from Users inner join History on Users.Id = History.UserId where History.Status = 'Victory' order by History.Score asc;",
      callback
    );
  },
